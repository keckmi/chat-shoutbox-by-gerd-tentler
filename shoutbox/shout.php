...
//========================================================================================================
	...
	$delete = isset($delete) ? (int) $delete : 0;
...
//========================================================================================================
	...
	if($HTTP_HOST == 'localhost' || preg_match('/^192\.168\.0\.[0-9]+$/', $HTTP_HOST)) {
...
//========================================================================================================
	...
	if(!$db_name || $mysqli = db_open($db_server, $db_user, $db_pass, $db_name)) {
		$error = '';
		$table_exists = true;
